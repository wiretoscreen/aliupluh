...
subprojects {
    ...
    aliucord {
        author("wiretoscreen", 460493336076091392)
        updateUrl.set("https://raw.githubusercontent.com/wiretoscreen/aliupluh/builds/updater.json")
        buildUrl.set("https://raw.githubusercontent.com/wiretoscreen/aliupluh/builds/%s.zip")
    }
